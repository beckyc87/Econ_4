...
MC_graph <- ggplot(data.frame(x=c(1, 250)), aes(x=x)) + 
  stat_function(fun = MC_A_fxn, geom = "line") + 
  stat_function(fun = MC_B_fxn, geom = "line") + 
  stat_function(fun = MC_C_fxn, geom = "line") + 
  stat_function(fun = MC_D_fxn, geom = "line") + 
...
demand_graph <- ggplot(data.frame(x=c(1, 250)), aes(x=x)) + 
  stat_function(fun = demand_A_fxn, geom = "line") + 
  stat_function(fun = demand_B_fxn, geom = "line") + 
  stat_function(fun = demand_C_fxn, geom = "line") + 
  stat_function(fun = demand_D_fxn, geom = "line") + 
  xlab("Carbon emissions (tons)") + 
  ylab("Price ($/ton)") +
  scale_x_continuous(expand = c(0,0), limits = c(0,250))+
  scale_y_continuous(expand = c(0,0), limits = c(0,200))+
