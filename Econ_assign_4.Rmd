...
```{r}
#Sector cost
capcost_a <- integrate(A_demand, 0, A)
capcost_a #8566.836

capcost_b <- integrate(A_demand, 0, B)
capcost_b #8461.072

capcost_c <- integrate(A_demand, 0, C)
capcost_c #8143.782 

#Total cost
capcost <- 8566.836 + 8461.072 + 8143.782
capcost #Total cost of the carbon cap policy is $25171.69
