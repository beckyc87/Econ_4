...
carbon_tidy <- melt(carbon_abate[c('Abatement',  'MC_A', 'MC_B', 'MC_C', 'MC_D')], id.vars = 1)
...
A_demand_price <- (model_A$coefficients[1] + model_A$coefficients[2]*180)
A_demand_price

B_demand_price <- (model_B$coefficients[1] + model_B$coefficients[2]*200)
B_demand_price

C_demand_price <- (model_C$coefficients[1] + model_C$coefficients[2]*220)
C_demand_price

D_demand_price <- (model_D$coefficients[1] + model_D$coefficients[2]*300)
D_demand_price
